...
DATASET = "flower17"
appr_levels = [l/1020 for l in [10, 50, 100, 200]]
...
dict_to_csv({'accuracy':acc_list,'error':std_list,'train_time':train_time_list,'test_time':test_time_list,'appr_levels':appr_levels},["nb_iter={},cv={}".format(1,3)],PATH+".csv")
